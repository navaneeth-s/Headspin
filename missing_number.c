...
// numbers[] is the array containing 100 numbers from 1 to 100, you can change the array or any of the number to find the missing number in between 1 to 100.
